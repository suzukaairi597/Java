...
CREATE TABLE User2
    ...
    SELECT * FROM User2;
    INSERT INTO User1 VALUES ('A101', '정약용', '010-7897-1123', 22);
    ...
    INSERT INTO Child VALUES ('Cl05', '이수영', '010-1234-1005', 'P100');
	...
	INSERT INTO User4 VALUES ('A104', '강감찬', 'M', 242, '010-1234-4444', '서울시 관악구');
    ...
    INSERT INTO User5 (name, gender, age, addr) VALUES ('신사임당', 'M', -1, '강릉시');
    SELECT * FROM User5;
